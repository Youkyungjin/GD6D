...
<head>
    ...
    <link href="/_common/fonts/css/font-awesome.min.css" rel="stylesheet">
    ...
    <script src="/_common/js/jquery-2.1.4.min.js"></script>
    <!--[if lt IE 9]>
        ...
        <div id="wrapper">
            <div id="login" class="animate form">
                <section class="login_content">
                    <form action="/admin/util/login", method="POST" >
                        <h1>Login Form</h1>
                        <div>
...
<!--                             </p> -->
                            ...
                            <br />
                            <div>
                                <h1><i class="fa fa-paw" style="font-size: 26px;"></i> GD6D Site!</h1>
